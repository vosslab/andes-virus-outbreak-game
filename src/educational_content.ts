...
export const TRANSMISSION_SCENARIOS = [
  {
    ...
    assumption:
      "Scenario assumption: a symptomatic passenger spends a long time " + "close to a cabin mate.",
    explanation:
  ...
  },
  {
    ...
    assumption: "Scenario assumption: people sit together in a close indoor space for a full meal.",
    explanation:
...
export const EDUCATION_PANELS = [
  ...
  },
  {
    ...
    tone: "classroom",
    summary: "Flattening the curve means slowing spread so serious cases do not surge all at once.",
    classroomText:
