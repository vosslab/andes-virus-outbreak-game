  ...
  normal_cruise: {
    ...
    assumptions: [
      ...
      },
      {
        ...
        description: "Infectious passengers may be routed to isolation after symptoms are noticed.",
      },
      {
        label: "Scenario assumption: fomites off by default",
        description: "Surface spread is not included unless the what-if fomite toggle is enabled.",
      },
    ],
  },
  reduced_gathering: {
    ...
    assumptions: [
      {
        ...
        description: "Passengers still move around, but fewer people collect in public spaces.",
      },
      {
        label: "Scenario assumption: fomites off by default",
        description: "Surface spread is not included unless the what-if fomite toggle is enabled.",
    ...
    assumptions: [
      {
        ...
        description: "Once infectious, passengers are more likely to be moved to isolation.",
      },
      {
        label: "Scenario assumption: fomites off by default",
        description: "Surface spread is not included unless the what-if fomite toggle is enabled.",
    ...
    assumptions: [
      {
        ...
        description: "Cleaning lowers the what-if surface route and slightly lowers public risk.",
      },
      {
        label: "Scenario assumption: fomites off by default",
        description: "Surface spread is not included unless the what-if fomite toggle is enabled.",
    ...
    assumptions: [
      {
        ...
        description: "Agents have doubled variance in speed, reaction time, and contact behavior.",
      },
      {
        label: "Scenario assumption: shared activities",
        description: "Dining, lounge, and pool visits create the main passenger contacts.",
